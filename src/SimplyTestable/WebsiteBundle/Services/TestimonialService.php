...
class TestimonialService {
    ...
    private $testimonialData = array(
        array(
            'content' => 'I like to validate a site before it goes live, but for large sites this is a pain. However, simplytestable takes the pain right out of it. Fire off the test, make yourself a cuppa and bickety bam! Your whole site validated.',
    ...
    /**
     * 
     * @return \SimplyTestable\WebsiteBundle\Model\Testimonial
     */
